...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 text-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 animate-pulse-glow"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 animate-pulse-glow"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-400 hover:text-emerald-300 transition-colors hover:translate-x-1 inline-block">Home</Link></li>
              <li><Link to="/blog" className="text-gray-400 hover:text-emerald-300 transition-colors hover:translate-x-1 inline-block">Blog</Link></li>
              <li><Link to="/categories" className="text-gray-400 hover:text-emerald-300 transition-colors hover:translate-x-1 inline-block">Categories</Link></li>
              <li><a href="#" className="text-gray-400 hover:text-emerald-300 transition-colors hover:translate-x-1 inline-block">Buying Guides</a></li>
              <li><Link to="/about" className="text-gray-400 hover:text-emerald-300 transition-colors hover:translate-x-1 inline-block">About Us</Link></li>
            </ul>
          </div>
              ...
              {categories?.map((category) => (
                <li key={category}>
                  <a 
                    ...
                    className="text-gray-400 hover:text-emerald-300 transition-colors hover:translate-x-1 inline-block"
                  >
                    {category}
                  </a>
                </li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-emerald-300">Contact Us</h4>
            <ul className="space-y-3">
              <li className="flex items-center text-gray-400 hover:text-emerald-300 transition-colors">
              ...
              <li className="flex items-start text-gray-400 hover:text-emerald-300 transition-colors">
                <MapPin className="h-5 w-5 mr-2 text-emerald-400 mt-0.5" />
        ...
        <div className="border-t border-gray-700/50 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              <Link to="/privacy" className="text-gray-400 hover:text-emerald-300 transition-colors">Privacy Policy</Link>
              <Link to="/terms" className="text-gray-400 hover:text-emerald-300 transition-colors">Terms of Service</Link>
              <Link to="/disclaimer" className="text-gray-400 hover:text-emerald-300 transition-colors">Disclaimer</Link>
            </div>
          </div>
        </div>
      </div>
